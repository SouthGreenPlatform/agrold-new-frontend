  ...
  <div class="foowrap m-4 d-flex flex-column">
    ...
    <div class="d-flex align-items-center flex-xl-row flex-column">
      <div>
        <h4>What is it?</h4>
        <p>
          Relfinder reformed is a reimplementation of the now deprecated <a
            href="https://github.com/VisualDataWeb/RelFinder">RelFinder</a>.
          It is a tool for the interactive exploration and visualization of relationships between entities in RDF data.
          This tool will help
        ...
        <h4>Links</h4>
        <ul>
          <li><a :href="REL_FINDER_URL">Link to our instance</a></li>
